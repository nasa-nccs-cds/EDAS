...
libraryDependencies ++= ( Dependencies.cache  ++ Dependencies.geo ++ Dependencies.xml ++ Dependencies.netcdf ++ Dependencies.socket ++ Dependencies.utils ++ Dependencies.test  ) // ++ Dependencies.jackson ++ Dependencies.breeze
...
edasDefaultLocalRunScript := baseDirectory.value / "bin" / "startup_edas_local.sh"
