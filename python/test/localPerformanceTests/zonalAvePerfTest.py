...
cldraGISSdset = "file://%s/collections/NCML/GISS_E2H_r1i1p1.ncml" % ( edas_cache_dir )
cldraMERRAdset = "file://%s/collections/NCML/CIP_MERRA2_1hr_T2M.ncml" % ( edas_cache_dir )
localGISSdset = "file://%s/collections/NCML/giss_r1i1p1.xml" % ( edas_cache_dir )
...
#    datainputs = '[domain=[{"name":"d0","lat":{"start":30,"end":40,"system":"indices"},"lon":{"start":30,"end":40,"system":"indices"},"lev":{"start":10,"end":10,"system":"indices"},"time":{"start":0,"end":100,"system":"indices"}}],variable=[{"uri":"file:///home/tpmaxwel/.edas/cache/collections/NCML/GISS_E2H_r1i1p1.ncml","name":"tas:v1","domain":"d0"}],operation=[{"name":"CDSpark.max","input":"v1","axes":"xy"}]]'
