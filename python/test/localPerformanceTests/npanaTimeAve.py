...
#    datainputs = """[domain=[{"name":"d0","time":{"start":0,"end":1000,"system":"indices"}}],variable=[{"uri":"file://att/gpfsfs/ffs2004/ppl/tpmaxwel/.edas/cache/collections/NCML/npana.xml","name":"T:v1","domain":"d0"}],operation=[{"name":"python.cdmsModule.ave","input":"v1","domain":"d0","axes":"tz"}]]"""
    datainputs = """[domain=[{"name":"d0","time":{"start":0,"end":100,"system":"indices"}}],variable=[{"uri":"file://att/gpfsfs/ffs2004/ppl/tpmaxwel/.edas/cache/collections/NCML/npana.xml","name":"T:v1","domain":"d0"}],operation=[{"name":"CDSpark.sum","input":"v1","domain":"d0","axes":"tz"}]]"""
