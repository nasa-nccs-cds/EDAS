...
class DASSTestSuite extends EDASTestSuite {
  ...
  test("SpaceAve-weighted") {
    val datainputs = s"""[domain=[{"name":"d0","time":{"start":"1960-01-01T00:00:00","end":"1960-01-05T00:00:00","system":"timestamps"}}],variable=[{"uri":"collection://iap-ua_eraint_tas1hr","name":"tas:v1","domain":"d0"}],operation=[{"name":"CDSpark.ave","input":"v1","domain":"d0","weights":"cosine","axes":"t"}]]"""
