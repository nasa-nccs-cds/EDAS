...
import nasa.nccs.esgf.process.{RegridSpec, _}
...
//class EDASExecutionContext( val operation: OperationContext, val request: RequestContext, val server: ServerContext ) extends Loggable  {
